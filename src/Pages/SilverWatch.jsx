...
const SilverWatch = () => {
  ...
  return (
    ...
    <div className="right m-auto">
        <h1 className='mb-5 uppercase text-3xl font-semibold text-nav sm:text-center md:text-center'>Men luxury silver watch</h1>
        ...
        The Varsity Silver Watch flaunts an embroidery of the official emblem in front, which is referenced in this collection to create a classic appearance and finished with tradition masks at the rear.
