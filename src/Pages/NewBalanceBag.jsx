...
const NewBalanceBag = () => {
  ...
  return (
    ...
    <div className="right m-auto">
        <h1 className='mb-5 uppercase text-3xl font-semibold text-nav sm:text-center md:text-center'>New balance crossed bag in green</h1>
        <div className='flex  text-xl font-semibold mb-5 sm:items-center sm:justify-center md:items-center md:justify-center'>
        <h2>$20</h2>
        ...
        The Varsity Nwe Balance crossed bag flaunts an embroidery of the official emblem in front, which is referenced in this collection to create a classic appearance and finished with tradition masks at the rear.
