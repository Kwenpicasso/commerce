...
const MartenBlack = () => {
  ...
  return (
    ...
    <div className="right m-auto">
        <h1 className='mb-5 uppercase text-3xl font-semibold text-nav sm:text-center md:text-center'>dr. martens shoe in black</h1>
        <div className='flex gap-3 text-xl font-semibold mb-5 sm:items-center sm:justify-center md:items-center md:justify-center'>
        <h2>$60</h2>
        <h2 className='text-red-300'><strike>$100</strike></h2>

        </div>

        <p className='text-sm mb-5 sm:text-center md:text-center'>
        The Varsity Dr.Martens Shoe flaunts an embroidery of the official emblem in front, which is referenced in this collection to create a classic appearance and finished with tradition masks at the rear.
